...
Mobile.verifyElementText(findTestObject('Object Repository/M25SP5DGA-21/07_VerifyAmountAndCurrency - RM 18,042.00'), 'RM 18,042.00*')
...
Mobile.verifyElementText(findTestObject('M25SP5DGA-21/09_VerifyText - Based on indicative rates as at 03 Dec 2023', [('text') : '*Based on indicative rates as at ' + 
            formattedDate]), '*Based on indicative rates as at ' + formattedDate)
